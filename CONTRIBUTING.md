# Contribution to DotPulsar Extensions

You can contribute to DotPulsar Extensions with issues and PRs. Simply filing issues for problems you encounter is a great way to contribute. Contributing implementations is greatly appreciated.
...
Before filing a new issue, please search our [open issues](https://github.com/smbecker/dotpulsar-extensions/issues) to check if it already exists.
...
7. Create a pull request (PR) against the smbecker/dotpulsar-extensions repository's **main** branch.
